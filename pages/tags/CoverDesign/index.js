...
export default function CoverDesign({ data }) {
  ...
  const coverDesign = getAllTags.filter(
    (project) => project.tags && project.tags.includes('Cover Design')
  )

  return (
    <>
      <div className="coverDesignWrapper">
        <ResponsiveMasonry columnsCountBreakPoints={{ 350: 1, 750: 2, 900: 3 }}>
          <Masonry columnsCount={2} gutter={3}>
            {coverDesign.map((elem) => (
              <div>
